      ...
      <div className="wrapper">
        <article>
          ...
          <div className="desc full">
            ...
            <p>
              I am a full stack web developer and Android app developer based in
              the beautiful east coast of India, Visakhapatnam.
            </p>
            <p>
              ...
              better. I also write technical blogs
              <a
                href="https://medium.com/@luckyudbhav"
                target="_blank"
          ...
          <div className="desc">
            ...
            <p>
              ...
              whenever the project requires PHP, I do PHP as well and I also
              work with python (Flask).
            </p>
          </div>
          <div className="desc">
            <h4 className="subtitle">competitive programmer</h4>
            <p>
              I have learnt competitive programming by using websites like
              LeetCode, HackerRank, CodeChef. I have a maintained a good profile
              in these websites.
            </p>
          </div>
        </article>
    ...
    <section id="projects">
      <div className="projects-container">
        ...
        <div className="projects-wrapper">
          ...
          >
            <small>Built using Javascript, HTML, python, css.</small>
            <p>
              This is the website that I made which predict the health condition
              based on the symptoms and also suggest medicitions for it.
            </p>
          </Project>
          <Project
          ...
          >
            <small>Built using Python, Jupyter Notebook, HTML.</small>
            <p>
              This project mainly focus on Machine learning which predicts the
              type of Sentiment does the statement contains.
            </p>
          </Project>
          <Project
          ...
          >
            ...
            <p>A website where every connected user can group chat in it.</p>
          </Project>
          <Project
            title="Fruit Catcher."
          ...
          >
            ...
            <p>It is a 2D game developed in unity using C#.</p>
          </Project>
        </div>
      </div>
    </section>
      ...
      <div className="container">
        ...
        >
          <input
            type="hidden"
            name="access_key"
            value="44f6c836-67c2-406d-9d97-7ae4263a0821"
          />
